        ...
        <el-tabs @tab-click="tabChange()" v-model="active" tab-position="left">
            <el-tab-pane name="1" label="基本信息">
                ...
                <el-form-item label="商品分类">
                    <!-- 级联选择器 -->
                    <el-cascader clearable v-model="selectedOptions" :props="defaultProp" :options="options" @change="handleChange"></el-cascader>
                </el-form-item>
            </el-tab-pane>
    ...
    methods: {
        ...
        async addGoods(){
            ...
            let arr2 = this.arrStaticparams.map((item)=>{
                return {arr_id:item.attr_id,attr_value:item.attr_vals}
            })
