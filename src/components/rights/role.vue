...
<el-card>
    ...
    <el-row class="addRoleBtn">
        <el-col>
            <el-button type="info" @click="AddRoleDialogVisible=true">添加角色</el-button>
        </el-col>
    </el-row>
    ...
    <el-table :data="rolelist" border stripe>
        ...
        <el-table-column prop="address" label="操作">
            <template slot-scope="scope">
                <el-button size="mini" plain type="primary" icon="el-icon-edit" circle @click="showEditDialog(scope.row.id)"></el-button>
                <el-button size="mini" plain type="danger" icon="el-icon-delete" circle @click="removeRoleById(scope.row.id)"></el-button>
